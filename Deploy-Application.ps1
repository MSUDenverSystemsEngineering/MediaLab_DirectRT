...
Try {
	...
	[string]$appVendor = 'Emperisoft'
	[string]$appName = 'MediaLab and DirectRT'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirFiles\DirectRT" -Destination "C:\" -Recurse
		Copy-File -Path "$dirFiles\MediaLab" -Destination "C:\" -Recurse
		Copy-File -Path "$dirSupportFiles\DirectRT 2016.lnk" -Destination "$envCommonDesktop"
		Copy-File -Path "$dirSupportFiles\MediaLab 2016.lnk" -Destination "$envCommonDesktop"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-Folder -Path "C:\DirectRT"
		Remove-Folder -Path "C:\MediaLab"
		Remove-File -Path "$envCommonDesktop\DirectRT 2016.lnk"
		Remove-File -Path "$envCommonDesktop\MediaLab 2016.lnk"
